...
const SearchResults = ({results}) => {
  ...
  return (
    <div className="w-[350px] lg:w-[410px] bg-[#F5F9FF] flex flex-col justify-center shadow-md rounded-b h-fit max-h-[500px] overflow-y-scroll absolute top-28 md:top-16 left-[50%] translate-x-[-50%] z-40 px-3 gap-2" id="searchList">
